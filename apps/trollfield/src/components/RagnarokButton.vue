...
export default {
     ...
     methods: {
         toggleR() {
             this.isRagnarok = !this.isRagnarok;
             this.$emit('rChanged', this.isRagnarok);
         },
     }
 }
